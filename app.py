...
def main():
    ...
    left_column.title("How can I say...")
    ...
    right_column.button("Translate", on_click=translate, type="primary", use_container_width=True)
    ...
    right_column.markdown(f"**{st.session_state.translation}**")

    if st.session_state.translation:
        right_column.audio("translation.mp3", format="audio/mp3")
        st.divider()
